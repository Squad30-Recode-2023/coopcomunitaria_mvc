			...
			<table class="table table-responsive table-hover">
				...
				<tbody>
					<c:forEach items="${listaServicos}" var="s">
						<tr>
							<td style="color: red; background-color: white">${s.id_servico}</td>
							<td style="color: red; background-color: white">${s.categoria}</td>
							<td style="color: red; background-color: white">${s.nome_do_servico}</td>
							<td style="color: red; background-color: white">${s.preco}</td>
							<td style="color: red; background-color: white">${s.e1.nome_empresa}</td>
							<td style="color: red; background-color: white">${s.c1.nome_cliente}</td>
							<td style="color: red; background-color: white">
								<div class="d-flex">
									...
									</a> <a href="servico-delete?id_servico=${s.id_servico}" class="mx-1"
										title="Cancelar"
