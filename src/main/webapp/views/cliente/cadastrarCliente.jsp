	...
	<main class="container_formulario">
		<div class="ajustes-cor-formulario">
			...
			<form action="../../cliente-create">
				<fieldset class="caixa_formulario campo" >
					<div class="campo">
						<label for="register-number">CPF</label> <input type="text"
							name="cpf" id="cpf" placeholder="Digite seu CPF">
					</div>
					...
					<div class="campo">
						<input type="submit" value="Enviar"> <a
							href="../../cliente" class="btn btn-danger"
