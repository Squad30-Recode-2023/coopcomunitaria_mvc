...
CREATE TABLE `servico` (
  ...
  `nome_do_serviço` varchar(50) DEFAULT NULL,
...
CREATE VIEW Cliente_Empresa AS
select s.id_servico, s.nome_do_servico, s.preco, s.categoria, e.*, c.* from Servico s, Empresa e, Cliente c where s.id_empresa = e.id_empresa and s.id_cliente = c.id_cliente;
...
-- Dump completed on 2023-11-12 19:47:35
